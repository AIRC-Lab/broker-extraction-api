...
def process_pdf_task(self, pdf_path: str):
    ...
    try:
        ...
        for i, image in enumerate(page_images):
            self.update_state(state='PROGRESS', meta={'current_step': f'Processing page {i+1}/{len(page_images)}'})
        ...
        self.update_state(state='PROGRESS', meta={'current_step': 'Finished processing', 'excel_file_path': output_excel_path})

        return {"status": "success", "message": "PDF processed successfully", "excel_file_path": output_excel_path}
